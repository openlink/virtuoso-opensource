...
#ifndef VPCOMPAT
static void *virt_malloc(size_t size);
static void virt_free(void* ptr);
void *(*pcre_malloc)(size_t) = virt_malloc;
void  (*pcre_free)(void *) = virt_free;
...
for (;;)
  ...
  switch(op)
    ...
    if (md->recursive != NULL && md->recursive->group_num == 0)
      ...
      memmove((unsigned char *) md->offset_vector, (unsigned char *) rec->offset_save,
