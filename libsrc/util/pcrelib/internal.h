...
#define pcre_default_tables virtpcre_default_tables
...
#define pcre_memmove virtpcre_memmove
...
for debugging, in pcre.c when PCRE_DEBUG is defined, and also in pcretest.c. The
