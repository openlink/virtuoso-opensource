  ...
  public static void main (String[] args)
    {
      ...
      try
	{
	  String driver = "virtuoso.jdbc.Driver";
	  ...
	  PreparedStatement stmt = ((VirtuosoConnection)con).prepareStatement("select * from sys_users",
	      VirtuosoResultSet.TYPE_SCROLL_INSENSITIVE,
	      VirtuosoResultSet.CONCUR_READ_ONLY);
