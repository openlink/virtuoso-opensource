 ...
 * @see virtuoso.jdbc4.VirtuosoConnection#prepareStatement
 */
public class VirtuosoPreparedStatement extends VirtuosoStatement implements PreparedStatement
{
    ...
    *
    * @exception virtuoso.jdbc4.VirtuosoException  If a database access error occurs.
    * @see virtuoso.jdbc4.VirtuosoStatement#getResultSet
    * @see virtuoso.jdbc4.VirtuosoStatement#getUpdateCount
    * @see virtuoso.jdbc4.VirtuosoStatement#getMoreResults
