 ...
 * <pre>
 *   <code>Class.forName("virtuoso.jdbc4.Driver")</code>
 * </pre>
 ...
 * the <i>CLASSPATH</i> with the <b>java virtuoso.jdbc4.Driver</b>
 * </ul>
 *
 * @version 1.0 (JDBC API 2.0 implementation)
 * @see java.sql.Driver
 * @see java.sql.DriverManager
 * @see virtuoso.jdbc4.VirtuosoConnection
 */
public class Driver implements java.sql.Driver
{
   ...
   protected static final int minor = 109;
...
//		       new java.io.FileOutputStream (log_file), 4096));
    ...
    * @exception virtuoso.jdbc4.VirtuosoException it is the right
