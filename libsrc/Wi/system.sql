...
create procedure DB.DBA.__MAKE_UNICODE3_COLLATIONS ()
{
  declare ctr integer;
...
-- Lowercase
  ...
  insert soft DB.DBA.SYS_COLLATIONS (COLL_NAME, COLL_TABLE, COLL_WIDE) values (ccname, cast (tbl as varbinary), 1);
