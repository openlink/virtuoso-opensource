...
EXE_EXPORT (caddr_t, charset_recode_from_named_to_named, (caddr_t narrow, const char *cs1_uppercase, const char *cs2_uppercase, int *res_is_new_ret, caddr_t *err_ret));
