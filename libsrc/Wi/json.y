...
value	: STRING  { $$ = $1; }
      	| NUMBER  { $$ = $1; }
	| TRUE_L  { $$ = ((jsonp_arg->jflags & JFLG_BOOL_BOX) ? t_list(2, t_alloc_box(0, DV_COMPOSITE), t_box_num (1)) : t_box_num (1)); }
	| FALSE_L { $$ = ((jsonp_arg->jflags & JFLG_BOOL_BOX) ? t_list(2, t_alloc_box(0, DV_COMPOSITE), t_box_num (0)) : t_box_num (0)); }
