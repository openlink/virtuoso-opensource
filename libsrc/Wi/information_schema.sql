...
order by KEY_TABLE, KEY_NAME, KP_NTH
;
...
select
 ...
 coalesce (P_TEXT,
  blob_to_string (
  P_MORE)) 		AS ROUTINE_DEFINTION     	VARCHAR,
...
select
 ...
 NULL						AS UNIQUE_CONSTRAINT_CATALOG 	VARCHAR(128),
 NULL						AS UNIQUE_CONSTRAINT_SCHEMA 	VARCHAR(128),
 NULL						AS UNIQUE_CONSTRAINT_NAME 	VARCHAR(128),
...
group by FK_TABLE, FK_NAME, fk.UPDATE_RULE, fk.DELETE_RULE
;
