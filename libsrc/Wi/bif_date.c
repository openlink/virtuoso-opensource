...
bif_date_init ()
{
  ...
  bif_define_ex ("current_timestamp"		, bif_timestamp				, BMD_RET_TYPE, &bt_datetime	, /*BMD_IS_PURE,*/ BMD_DONE);	/* This is standard name? */
  bif_define_ex ("curdate"			, bif_curdate				, BMD_RET_TYPE, &bt_date	, /*BMD_IS_PURE,*/ BMD_DONE);	/* This is standard fun. */
  bif_define_ex ("current_date" 		, bif_curdate				, BMD_RET_TYPE, &bt_date	, /*BMD_IS_PURE,*/ BMD_DONE);	/* This is standard fun. */
