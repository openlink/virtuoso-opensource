...
#define SPAR_BIF_REPLACE	(ptrlong)1128
#define SPAR_BIF_ROUND		(ptrlong)1129
#define SPAR_BIF_SAMETERM	(ptrlong)1130
#define SPAR_BIF_SECONDS	(ptrlong)1131
#define SPAR_BIF_SHA1		(ptrlong)1132
#define SPAR_BIF_SHA224		(ptrlong)1133
#define SPAR_BIF_SHA256		(ptrlong)1134
#define SPAR_BIF_SHA384		(ptrlong)1135
#define SPAR_BIF_SHA512		(ptrlong)1136
#define SPAR_BIF_STR		(ptrlong)1137
#define SPAR_BIF_STRAFTER	(ptrlong)1138
#define SPAR_BIF_STRBEFORE	(ptrlong)1139
#define SPAR_BIF_STRDT		(ptrlong)1140
#define SPAR_BIF_STRENDS	(ptrlong)1141
#define SPAR_BIF_STRLANG	(ptrlong)1142
#define SPAR_BIF_STRLEN		(ptrlong)1143
#define SPAR_BIF_STRSTARTS	(ptrlong)1144
#define SPAR_BIF_STRUUID	(ptrlong)1145
#define SPAR_BIF_SUBSTR		(ptrlong)1146
#define SPAR_BIF_TIMEZONE	(ptrlong)1147
#define SPAR_BIF_TZ		(ptrlong)1148
#define SPAR_BIF_UCASE		(ptrlong)1149
#define SPAR_BIF_URI		(ptrlong)1150
#define SPAR_BIF_UUID		(ptrlong)1151
#define SPAR_BIF_VALID		(ptrlong)1152
#define SPAR_BIF_YEAR		(ptrlong)1153
#define SPAR_BIF__ITEM_IN_VECTOR	(ptrlong)1154
