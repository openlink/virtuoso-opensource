...
/*"  dbg_obj_print (obd);"*/
"  is_part := 0; \n"
"  if (exists (select 1 from DB.DBA.SYS_PARTITION where 0 = casemode_strcmp (PART_TABLE, tb))) \n"
"    is_part := 1; \n"
...
"  text_value := concat (\n"
"      sprintf (\n"
"	\'create procedure %s\"VT_BATCH_REAL_PROCESS_%s\" (inout invd any, in doc_id int)\\\n\', dbpref, data_table_suffix),\n"
"	\'{\n\',"
...
"  text_value := concat (\n"
"      sprintf (\n"
"	\'create procedure %s\"VT_BATCH_PROCESS_%s\" (inout vtb any, in doc_id int)\\\n\', dbpref, data_table_suffix),\n"
"	\'{\n{\n"
"	   declare invd any;\n"
...
"	       \\\n\',\n"
"      sprintf (\n"
"	\'      %s\"VT_BATCH_PROCESS_%I\" (vtb, _vt_id_);\\\n\', dbpref, data_table_suffix),\n"
"      sprintf (\n"
"	\'   vtb := vt_batch (8191 %s);\n\', _lang_enc_args ),\n"
"	\'   vt_batch_alpha_range (vtb, low_w, high_w); \n"
"	       commit work;\n start := _vt_id_;\n"
...
"	 done:\\\n\',\n"
"      sprintf (\n"
"	\'  %s\"VT_BATCH_PROCESS_%I\" (vtb, start);\\\n\', dbpref, data_table_suffix),\n"
"	\'  return;\n"
" deadl: \n"
"   close cr;\n"
"   rollback work;\n"
...
"		} \n"
"	      start := _vtlog_id; \n"
"	      <DB>.<DBA>.\"VT_BATCH_PROCESS_<SUFF>\" (vtb, _vtlog_id); \n"
"	      vtb := vt_batch (1001 <LANG_ENC>); \n"
