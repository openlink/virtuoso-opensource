...
del sql_code_ddk.c
set SQL_FILES_DDK=users.sql replddk.sql ..\..\binsrc\tests\dav\davddk.sql mail_cli.sql ..\..\binsrc\vsp\admin\admin_ddl.sql ..\..\binsrc\vsp\admin\admin_dav\vfsddk.sql virtual_dir.sql
...
del sql_code_dav.c
set SQL_FILES_DAV=..\..\binsrc\tests\dav\dav.sql ..\..\binsrc\tests\dav\dav_api.sql ..\..\binsrc\tests\dav\dav_acct.sql ..\..\binsrc\vsp\admin\admin_dav\vfs.sql ../../binsrc/tests/dav/davxml2rdfxml.xsl ../../binsrc/tests/dav/davxml2n3xml.xsl ../../binsrc/tests/dav/rdfxml2n3xml.xsl ../../binsrc/tests/dav/n3xml2uriqahtml.xsl ..\..\binsrc\tests\dav\uriqa.sql ..\..\binsrc\tests\dav\DET_CatFilter.sql ..\..\binsrc\tests\dav\DET_HostFs.sql ..\..\binsrc\tests\dav\DET_ResFilter.sql ..\..\binsrc\tests\dav\DET_PropFilter.sql ..\..\binsrc\tests\dav\Versioning\DET_Versioning.sql
