...
The Jena Provider can be compiled with JDK 1.5 or newer.
  ...
  * Download these .jar files from the openrdf project at http://jena.sourceforge.net/ and copy them into this lib directory:
...
```
  ...
  * Download these .jar files from the Apache XML Project at http://xml.apache.org/mirrors.cgi and copy them into this lib directory:
