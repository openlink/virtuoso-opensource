...
--  
--  
USER_CREATE('WebCal', 'WebCal', 
	vector('LOGIN_QUALIFIER', 'WebCal',
	       'FULL_NAME', 'PHP WebCalendar Demo user',
                'LOGIN_QUALIFIER', 'WebCal'))
;

USE WebCal;

DROP TABLE WebCal.webcal_user;
CREATE TABLE WebCal.webcal_user (
...
DROP TABLE WebCal.webcal_entry;
CREATE TABLE WebCal.webcal_entry (
  ...
  cal_description LONG VARCHAR,
  PRIMARY KEY (cal_id)
)
;

DROP TABLE WebCal.webcal_entry_repeats;
CREATE TABLE WebCal.webcal_entry_repeats (
...
DROP TABLE WebCal.webcal_entry_repeats_not;
CREATE TABLE WebCal.webcal_entry_repeats_not (
  cal_id INTEGER NOT NULL,
  cal_date INTEGER NOT NULL,
...
DROP TABLE WebCal.webcal_entry_user;
CREATE TABLE WebCal.webcal_entry_user (
...
DROP TABLE WebCal.webcal_entry_ext_user;
CREATE TABLE WebCal.webcal_entry_ext_user (
  cal_id INTEGER DEFAULT 0 NOT NULL,
...
DROP TABLE WebCal.webcal_user_pref;
CREATE TABLE WebCal.webcal_user_pref (
  cal_login VARCHAR(25) NOT NULL,
...
DROP TABLE WebCal.webcal_user_layers;
CREATE TABLE WebCal.webcal_user_layers (
...
DROP TABLE WebCal.webcal_site_extras;
CREATE TABLE WebCal.webcal_site_extras (
  cal_id INTEGER DEFAULT '0' NOT NULL,
  cal_name VARCHAR(25) NOT NULL,
  cal_type INTEGER NOT NULL,
  cal_date INTEGER DEFAULT '0',
  cal_remind INTEGER DEFAULT '0',
  cal_data LONG VARCHAR,
  PRIMARY KEY (cal_id, cal_name, cal_type)
)
;

DROP TABLE WebCal.webcal_reminder_log;
CREATE TABLE WebCal.webcal_reminder_log (
  cal_id INTEGER DEFAULT '0' NOT NULL,
  cal_name VARCHAR(25) NOT NULL,
...
DROP TABLE WebCal.webcal_group;
CREATE TABLE WebCal.webcal_group (
...
DROP TABLE WebCal.webcal_group_user;
CREATE TABLE WebCal.webcal_group_user (
  cal_group_id INTEGER NOT NULL,
  cal_login VARCHAR(25) NOT NULL,
...
DROP TABLE WebCal.webcal_view;
CREATE TABLE WebCal.webcal_view (
...
DROP TABLE WebCal.webcal_view_user;
CREATE TABLE WebCal.webcal_view_user (
  cal_view_id INTEGER NOT NULL,
  cal_login VARCHAR(25) NOT NULL,
...
DROP TABLE WebCal.webcal_config;
CREATE TABLE WebCal.webcal_config (
...
INSERT INTO webcal_config ( cal_setting, cal_value ) VALUES ( 'LANGUAGE', 'Browser-defined' );
...
INSERT INTO webcal_config ( cal_setting, cal_value ) VALUES ( 'email_fallback_from', 'youremailhere' );
...
INSERT INTO webcal_config ( cal_setting, cal_value ) VALUES ( 'BGCOLOR', '#C0C0C0' );
...
INSERT INTO webcal_config ( cal_setting, cal_value ) VALUES ( 'TODAYCELLBG', '#E0E0E0' );
INSERT INTO webcal_config ( cal_setting, cal_value ) VALUES ( 'STARTVIEW', 'week' );
...
DROP TABLE WebCal.webcal_entry_log;
CREATE TABLE WebCal.webcal_entry_log (
  ...
  cal_text LONG VARCHAR,
  PRIMARY KEY (cal_log_id)
)
;

DROP TABLE WebCal.webcal_categories;
CREATE TABLE WebCal.webcal_categories (
...
DROP TABLE WebCal.webcal_asst;
CREATE TABLE WebCal.webcal_asst (
