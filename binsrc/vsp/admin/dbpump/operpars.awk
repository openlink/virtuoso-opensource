...
#  
  ...
  print "create procedure \"PUMP\".\"DBA\".\"RETRIEVE_HTTP_PARS\" ( in afrom any )\n{" >sql_init;
...

{
  ...
  print "insert replacing \"PUMP\".\"DBA\".\"DBPUMP_HELP\" (\"name\",\"dflt\",\"short_help\",\"full_help\") values (" >> sql_incl;
  printf("'%s','%s','%s','%s')\n;\n",$1,$2,$3,$4) >>sql_incl;
