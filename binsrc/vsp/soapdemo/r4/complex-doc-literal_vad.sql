...
DB.DBA.exec_no_error('drop type DB.DBA."BaseStruct_literal"');
DB.DBA.exec_no_error('drop type DB.DBA."ExtendedStruct_literal"');
DB.DBA.exec_no_error('drop type DB.DBA."MoreExtendedStruct_literal"');
DB.DBA.exec_no_error('drop type DB.DBA."echoMultipleFaults1Request"');
DB.DBA.exec_no_error('drop type DB.DBA."echoMultipleFaults2Request"');

DB.DBA.exec_no_error('create type DB.DBA."BaseStruct_literal" as (
    "structMessage" DB.DBA."SOAPStruct" __soap_type \'http://soapinterop.org/types:SOAPStruct\',
    "shortMessage" int __soap_type \'short\')');

DB.DBA.exec_no_error('create type DB.DBA."ExtendedStruct_literal" under DB.DBA."BaseStruct_literal" as (
    "stringMessage" nvarchar __soap_type \'string\',
    "intMessage" int __soap_type \'int\',
    "anotherIntMessage" int __soap_type \'int\'
    )');

DB.DBA.exec_no_error('create type DB.DBA."MoreExtendedStruct_literal" under DB.DBA."ExtendedStruct_literal" as ("booleanMessage" smallint __soap_type \'boolean\')');

DB.DBA.exec_no_error('create type DB.DBA."echoMultipleFaults1Request" as (
    "whichFault" int,
    "param1" DB.DBA."SOAPStruct",
    "param2" DB.DBA."BaseStruct_literal")');

DB.DBA.exec_no_error('create type DB.DBA."echoMultipleFaults2Request" as (
    "whichFault" int,
...
USER_CREATE ('interop4hcd', uuid(), vector ('DISABLED', 1));
