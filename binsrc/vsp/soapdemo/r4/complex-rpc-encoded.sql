...
drop type DB.DBA."BaseStruct";
drop type DB.DBA."ExtendedStruct";
drop type DB.DBA."MoreExtendedStruct";
...
create type DB.DBA."SOAPStructFault" as ("soapStruct" DB.DBA."SOAPStruct");
...
create type DB.DBA."MoreExtendedStruct" under DB.DBA."ExtendedStruct" as ("booleanMessage" smallint __soap_type 'boolean');
