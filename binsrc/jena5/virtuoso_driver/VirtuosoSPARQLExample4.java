...
public class VirtuosoSPARQLExample4
{
	...
	System.out.println ("graph.contains(new Triple(foo2, bar2, baz2) - " + graph.contains(Triple.create(foo2, bar2, baz2)));
	System.out.println ("graph.contains(new Triple(foo2, bar2, baz3) - " + graph.contains(Triple.create(foo2, bar2, baz3)));
