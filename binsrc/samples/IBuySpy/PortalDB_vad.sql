...
DB.DBA.exec_no_error('DROP TABLE Announcements');
DB.DBA.exec_no_error('DROP TABLE Contacts');
DB.DBA.exec_no_error('DROP TABLE Discussion');
DB.DBA.exec_no_error('DROP TABLE Documents');
DB.DBA.exec_no_error('DROP TABLE Events');
DB.DBA.exec_no_error('DROP TABLE HtmlText');
DB.DBA.exec_no_error('DROP TABLE Links');
DB.DBA.exec_no_error('DROP TABLE ModuleSettings');
DB.DBA.exec_no_error('DROP TABLE Modules');
DB.DBA.exec_no_error('DROP TABLE ModuleDefinitions');
DB.DBA.exec_no_error('DROP TABLE Tabs');
DB.DBA.exec_no_error('DROP TABLE UserRoles');
DB.DBA.exec_no_error('DROP TABLE Users');
DB.DBA.exec_no_error('DROP TABLE Roles');
DB.DBA.exec_no_error('DROP TABLE Portals');
