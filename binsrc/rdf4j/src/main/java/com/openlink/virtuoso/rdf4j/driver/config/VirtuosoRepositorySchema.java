...
/**
 * Defines constants for the VirtuosoRepository schema which is used by {@link VirtuosoRepositoryFactory}s to initialize
 * {@link com.openlink.virtuoso.rdf4j.driver.VirtuosoRepository}s.
 */
