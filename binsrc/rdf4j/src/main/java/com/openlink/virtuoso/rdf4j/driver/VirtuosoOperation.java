...
public class VirtuosoOperation implements Operation {
    ...
    /**
     * Specifies the dataset against which to evaluate a query, overriding any dataset that is specified in the query
     * itself.
     */
    ...
    /**
     * Determine whether evaluation results of this query should include inferred statements (if any inferred statements
     * are present in the repository). The default setting is 'true'.
     *
     * @param includeInferred indicates whether inferred statements should included in the result.
     */
