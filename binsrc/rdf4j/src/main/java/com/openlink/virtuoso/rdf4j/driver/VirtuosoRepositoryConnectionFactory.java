...
public class VirtuosoRepositoryConnectionFactory {
    ...
    public synchronized RepositoryConnection getConnection(String user, String password, String delegate)
        ...
        if (_xads != null) {
            try {
                ...
                v = _xads.getCharset();
                if (v != null && !v.equalsIgnoreCase(StandardCharsets.UTF_8.name()))
                    _xads.setCharset(StandardCharsets.UTF_8.name());
            ...
            try {
                ...
                v = _pds.getCharset();
                if (v != null && !v.equalsIgnoreCase(StandardCharsets.UTF_8.name()))
                    _pds.setCharset(StandardCharsets.UTF_8.name());
            ...
            try {
                ...
                v = _ds.getCharset();
                if (v != null && !v.equalsIgnoreCase(StandardCharsets.UTF_8.name()))
                    _ds.setCharset(StandardCharsets.UTF_8.name());
            ...
            try {
                ...
                if (rep.getRoundrobin() && !url.toLowerCase().contains("roundrobin=")) {
                    if (url.charAt(url.length() - 1) != '/')
