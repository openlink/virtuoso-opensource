...
iSPARQL.QBE = function (def_obj) {
	...
	OAT.Dom.detach("menu_qbe_load",  "click",  self.func_load);
	OAT.Dom.detach("menu_qbe_save",  "click",  self.func_save);
	OAT.Dom.detach("menu_qbe_saveas","click",  self.func_saveas);
