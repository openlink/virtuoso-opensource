#!/bin/sh
#  
#  $Id: gtkbench.sh,v 1.10.6.1.4.5 2013/01/02 16:14:40 source Exp $
#
...
GTKBENCH=$VIRTUOSO_TEST/../../samples/GTK/gtkbench/gtk-bench
if [ "x$HOST_OS" != "x" ] 
then
GTKBENCH=$VIRTUOSO_TEST/../gtk-odbc-bench
fi
