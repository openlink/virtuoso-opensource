...
<!--
 -  
 -  $Id: sort-bidder-price-.xsl,v 1.4.10.1 2013/01/02 16:16:12 source Exp $
 -
...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/TR/WD-xsl">
  <xsl:template match="/">
    <TABLE STYLE="border:1px solid black">
      ...
      <xsl:for-each select="AUCTIONBLOCK/ITEM/BIDS/BID"><xsl:sort select="BIDDER"/><xsl:sort select="PRICE" data-type="number" order="descending" />
