...
DAV_AUTHENTICATE_HTTP (in id any, in what char(1), in req varchar, in can_write_http integer, inout a_lines any, inout a_uname varchar, inout a_pwd varchar, inout a_uid integer, inout a_gid integer, inout _perms varchar) returns integer
{
  ...
  if (isinteger (a_uid))
    ...
    {
      -- dbg_obj_princ ('DAV_AUTHENTICATE_HTTP has non-integer a_uid=', a_uid);
      a_uid := http_nobody_uid ();
      a_gid := http_nogroup_gid ();
      _perms := '110110110--';
    }
...
--  declare col_cr cursor for select COL_ID+1 from WS.WS.SYS_DAV_COL where COL_ID = pid;
  ...
  if (content_type = 'text/xml'
    ...
    if (op = 'i')
      {
        ...
        insert into WS.WS.SYS_DAV_RES (RES_ID, RES_NAME, RES_COL,
  	    ...
  	    values (rc, name, pid, ouid, ogid, permissions,
                cr_time, mod_time, type, content, _rowguid);
      if (_is_xper_res)
	...
	update WS.WS.SYS_DAV_RES set RES_OWNER = ouid, RES_GROUP = ogid,
            RES_PERMS = permissions,
            RES_CR_TIME = cr_time, RES_MOD_TIME = mod_time,
            RES_TYPE = type, RES_CONTENT = content, ROWGUID = _rowguid
    ...
    in auth_uname varchar := null, in auth_pwd varchar := null )
{
  ...
  if ((content_mode = 0) or (content_mode = 2))
  ...
  else if (content_mode = 3)
    {
      ...
      -- dbg_obj_princ ('wrote something to the HTTP output');
    }
  return rc;
}
;
...
create function "DAV_EXTRACT_RDF_application/msoffice+xml" (in orig_res_name varchar, inout content any, inout html_start any, inout docprops any)
{
  ...
  metas := vector (
        'http://www.openlinksw.com/schemas/MsWord#Title'	, 'declare namespace o="urn:schemas-microsoft-com:office:office"; o:Title'					, NULL,
        'http://www.openlinksw.com/schemas/MsWord#Author'	, 'declare namespace o="urn:schemas-microsoft-com:office:office"; o:Author|o:Creator'				, NULL,
        'http://www.openlinksw.com/schemas/MsWord#LastAuthor'	, 'declare namespace o="urn:schemas-microsoft-com:office:office"; o:LastAuthor'					, NULL,
        'http://www.openlinksw.com/schemas/MsWord#Company'	, 'declare namespace o="urn:schemas-microsoft-com:office:office"; o:Company'					, NULL,
        'http://www.openlinksw.com/schemas/MsWord#Words'	, 'declare namespace o="urn:schemas-microsoft-com:office:office"; o:Words'					, NULL,
        'http://www.openlinksw.com/schemas/MsWord#Pages'	, 'declare namespace o="urn:schemas-microsoft-com:office:office"; o:Pages'					, NULL,
        'http://www.openlinksw.com/schemas/MsWord#Lines'	, 'declare namespace o="urn:schemas-microsoft-com:office:office"; o:Lines'					, NULL,
        'http://www.openlinksw.com/schemas/MsWord#Last-Saved'	, 'declare namespace o="urn:schemas-microsoft-com:office:office"; o:LastSaved|o:TimeSaved'			, NULL,
        'http://www.openlinksw.com/schemas/MsWord#Last-Printed'	, 'declare namespace o="urn:schemas-microsoft-com:office:office"; o:LastPrinted|o:TimePrinted'			, NULL,
        'http://www.openlinksw.com/schemas/MsWord#Created'	, 'declare namespace o="urn:schemas-microsoft-com:office:office"; o:Created|o:TimeCreated|o:CreationDate'	, NULL );
  return "DAV_EXTRACT_RDF_BY_METAS" (docprops, metas);
...
create function "DAV_EXTRACT_RDF_application/xddl+xml" (in orig_res_name varchar, inout content any, inout html_start any)
{
  ...
  doc := xtree_doc (content, 0);
  metas := vector (
        'http://www.openlinksw.com/virtdav#dynRdfExtractor', '"application/xddl+xml"', NULL,
...
create function "DAV_EXTRACT_RDF_application/msword+xml" (in orig_res_name varchar, inout content any, inout html_start any)
{
  ...
  docprops := null;
  return "DAV_EXTRACT_RDF_application/msoffice+xml" (orig_res_name, content, html_start, docprops);
}
;
...
create function "DAV_EXTRACT_RDF_application/mods+xml" (in orig_res_name varchar, inout content any, inout html_start any)
{
  ...
  if (xpath_eval ('count (mods)', doc) <> 1)
    {
      metas := vector (
        'http://www.openlinksw.com/virtdav#dynRdfExtractor', '"application/mods+xml"', NULL,
...
create function "DAV_EXTRACT_RDF_application/opml+xml" (in orig_res_name varchar, inout content any, inout html_start any)
{
  ...
  --  goto final;
  metas := vector (
        'http://www.openlinksw.com/virtdav#dynRdfExtractor', '"application/opml+xml"', NULL,
...
create function "DAV_EXTRACT_RDF_text/html" (in orig_res_name varchar, inout content any, inout html_start any)
{
  ...
  return "DAV_EXTRACT_RDF_BY_METAS" (html_start, metas);
...
create function "DAV_EXTRACT_RDF_application/x-openlinksw-vsp" (in orig_res_name varchar, inout content any, inout html_start any)
{
  ...
  metas := vector (
        'http://www.openlinksw.com/schemas/VSPX#type', '"VSP"', NULL,
...
create function "DAV_EXTRACT_RDF_application/x-openlinksw-vspx+xml" (in orig_res_name varchar, inout content any, inout html_start any)
{
  ...
  --  goto final;
  metas := vector (
        'http://www.openlinksw.com/schemas/VSPX#type', '"VSPX"', NULL,
...
create function "DAV_EXTRACT_RDF_application/bpel+xml" (in orig_res_name varchar, inout content any, inout html_start any)
{
  ...
  --  goto final;
  metas := vector (
        'http://www.openlinksw.com/schemas/WSDL#type', '"BPEL"', NULL,
...
create function "DAV_EXTRACT_RDF_application/wsdl+xml" (in orig_res_name varchar, inout content any, inout html_start any)
{
  ...
  --  goto final;
  metas := vector (
        'http://www.openlinksw.com/schemas/WSDL#type', '"WSDL"', NULL,
...
{
  declare doc, metas, tree, cont any;
...
--    goto errexit;
  --  goto final;
  metas := vector (
        'http://www.openlinksw.com/virtdav#dynRdfExtractor', '"application/x-openlinksw-vad"', NULL,
  ...
  if (1)
    {
      ...
      declare metas any;
      metas := vector (
        'http://www.openlinksw.com/virtdav#dynRdfExtractor', '"text/wiki"', NULL,
      ...
      return "DAV_EXTRACT_RDF_BY_METAS" (_res, metas);
    }
}
;
...
{
  declare doc, diritems, res, metas any;
  xte_nodebld_init (res);
...
create function "DAV_EXTRACT_RDF_BY_METAS" (inout doc any, inout metas any)
{
  declare res any;
  declare ctr, len integer;
  -- dbg_obj_princ ('DAV_EXTRACT_RDF_BY_METAS" (', doc, metas, ')');
  xte_nodebld_init (res);
  whenever sqlstate '*' goto final;
  len := length (metas);
