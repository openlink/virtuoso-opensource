/*
   ...
   *           This program can be used for testing www-server software.
   *           It reads from a file a server address and a list of
   *           url-lines. It then writes these url-lines to the address
   *           given and reads back the responses.
   *
   *
   * AUTHOR:   Martti Ylikoski
   * CREATED:  30.1.1995
   * MODYFIER:   Vladimir Chesnokov
   * MODYFIED:  2003-07-09
   * COPYRIGHT: Infosto R&D
 */
