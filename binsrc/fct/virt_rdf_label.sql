...
<http://www.w3.org/2004/02/skos/core#exactMatch> rdfs:subPropertyOf owl:sameAs .
...
<http://watchdog.net/about/api#name> rdfs:subPropertyOf virtrdf:label .
<http://purl.org/dc/terms/identifier> a owl:inverseFunctionalProperty . 
<http://schema.org/name> rdfs:subPropertyOf virtrdf:label .
gr:ProductOrServicesSomeInstancesPlaceholder rdfs:subClassOf gr:ProductOrService .
gr:SomeItems rdfs:subClassOf gr:ProductOrService .
...
oplbase:contained_in_forum rdfs:subPropertyOf sioc:has_container .
