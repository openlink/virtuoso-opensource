...
grant execute on DB.DBA.S_SUM_INIT to "SPARQL_SELECT";
grant execute on DB.DBA.S_SUM_ACC to "SPARQL_SELECT";
grant execute on DB.DBA.S_SUM_FIN to "SPARQL_SELECT";
grant execute on DB.DBA.S_SUM to "SPARQL_SELECT";
grant execute on DB.DBA.SUM_RANK to "SPARQL_SELECT";
grant execute on s_sum_page to "SPARQL_SELECT"
grant execute on DB.DBA.IRI_AUTOCOMPLETE to PROXY;
grant execute on DB.DBA.IR_SRV to "PROXY";
grant execute on S_F to "SPARQL_SELECT";
grant execute on rnk_scale to "SPARQL_SELECT";
grant execute on DB.DBA.IR_SRV to "SPARQL_SELECT";
grant execute on IR_SRV to "SPARQL_SELECT";
grant execute on IRI_RANK to "SPARQL_SELECT";
grant execute on short2float to "SPARQL_SELECT";
grant execute on rnk_scale to "SPARQL_SELECT";
grant execute on DB.DBA.IR_SRV to "SPARQL_SELECT";
grant execute on IR_SRV to "SPARQL_SELECT";
grant execute on IRI_RANK to "SPARQL_SELECT";
