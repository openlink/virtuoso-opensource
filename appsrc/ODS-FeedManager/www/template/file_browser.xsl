        ...
        <v:form name="file_form1" type="simple" method="POST" action="">
          ...
          <table class="vdir_headertable" border="0" cellspacing="0" cellpadding="2">
            <tr class="vdir_headertr" align="left">
              ...
              <td class="vdir_headertd">
		  <v:button name="b_up22" style="image" value="image/dav_browser/up_16.png" xhtml_alt="Up one level" action="simple">
                  <v:before-render>
                    <v:script>
                      <![CDATA[
              ...
              <td class="vdir_headertd">
		  <v:button name="b_create2" style="image" value="image/dav_browser/foldr_new_16.png" xhtml_alt="Create new folder" action="simple">
                  <v:before-render>
                    <v:script>
                      <![CDATA[
		    ...
		    if (not length (self.curpath2))
			  ...
			  <?vsp
                  ...
                  <tr class="vdir_listrow">
                    <td>
			<v:button name="b_up23" style="image" value="image/dav_browser/up_16.png" xhtml_alt="Up one level" action="simple">
                        <v:on-post>
                          <v:script>
                            <![CDATA[
                              declare pos integer;
