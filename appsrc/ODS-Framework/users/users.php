...
<html>
  ...
  <body>
    <form name="page_form" method="post">
      ...
      <div id="ob">
        <div id="ob_left"><a href="/ods/?sid=<?php print($_sid); ?>&realm=<?php print($_realm); ?>">ODS Home</a> > Login</div>
        <?php
          if ($_form <> 'login')
          {
        ?>
                ...
                <div style="min-height: 180px; border: 1px solid #aaa; margin: -13px 5px 5px 5px;">
                  ...
                  <div id="page_0">
                    <table class="form" cellspacing="5">
                      ...
                      <tr>
                        ...
                        <td nowrap="nowrap">
                          <select name="pf_title" value="<?php print($_xml->user->title); ?>" id="pf_title">
                            <option value=""/>
                  ...
                  <div id="page_3" style="display:none;">
                    <table class="form" cellspacing="5">
                      ...
                      <tr>
                        ...
                        <td nowrap="nowrap">
                          <input type="text" name="pf_businessOrganization" value="" id="pf_businessOrganization" size="40" />
                        </td>
                      </tr>
                      <tr>
                        <th>
                  ...
                  <div id="page_4" style="display:none;">
                    <table class="form" cellspacing="5">
                      <tr>
                        <th width="30%">
                          <label for="pf_oldPassword">Password</label>
                        </th>
                        <td nowrap="nowrap">
                      ...
                      <tr>
                        <th width="30%">
                          <label for="pf_password">Password</label>
                        </th>
                        <td nowrap="nowrap">
    ...
    <div id="FT">
      ...
      <div id="FT_R">
        <a href="faq.html">FAQ</a> | <a href="privacy.html">Privacy</a> | <a href="rabuse.vspx">Report Abuse</a>
        <div>
