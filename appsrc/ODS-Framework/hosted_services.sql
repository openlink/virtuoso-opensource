...
create procedure wa_add_col(in tbl varchar, in col varchar, in coltype varchar) {
 if(exists(
           select
             top 1 1
           from
...
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Afghanistan',33,65);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Akrotiri',NULL,NULL);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Albania',41,20);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Algeria',28,3);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('American Samoa',-14.33333301544189,-170);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Andorra',42.5,1.5);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Angola',-12.5,18.5);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Anguilla',18.25,-63.16666793823242);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Antarctica',-90,0);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Antigua and Barbuda',17.04999923706055,-61.79999923706055);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Arctic Ocean',90,0);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Argentina',-34,-64);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Armenia',40,45);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Aruba',12.5,-69.96666717529297);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Ashmore and Cartier Islands',-12.23333358764648,123.0833358764648);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Atlantic Ocean',0,-25);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Australia',-27,133);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Austria',47.33333206176758,13.33333301544189);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Azerbaijan',40.5,47.5);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Bahamas, The',24.25,-76);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Bahrain',26,50.54999923706055);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Baker Island',0.2166666686534882,-176.5166625976562);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Bangladesh',24,90);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Barbados',13.16666698455811,-59.53333282470703);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Bassas da India',-21.5,39.83333206176758);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Belarus',53,28);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Belgium',50.83333206176758,4);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Belize',NULL,NULL);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Benin',9.5,2.25);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Bermuda',32.33333206176758,-64.75);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Bhutan',27.5,90.5);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Bolivia',-17,-65);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Bosnia and Herzegovina',44,18);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Botswana',-22,24);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Bouvet Island',-54.43333435058594,3.400000095367432);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Brazil',-10,-55);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('British Indian Ocean Territory',-6,71.5);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('British Virgin Islands',18.5,-64.5);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Brunei',4.5,114.6666641235352);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Bulgaria',43,25);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Burkina Faso',13,-2);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Burma',22,98);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Burundi',-3.5,30);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Cambodia',13,105);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Cameroon',6,12);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Canada',60,-95);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Cape Verde',16,-24);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Cayman Islands',19.5,-80.5);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Central African Republic',7,21);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Chad',15,19);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Chile',-30,-71);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('China',35,105);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Christmas Island',-10.5,105.6666641235352);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Clipperton Island',10.28333377838135,-109.216667175293);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Cocos (Keeling) Islands',-12.5,96.83333587646484);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Colombia',4,-72);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Comoros',-12.16666698455811,44.25);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Congo, Democratic Republic of the',0,25);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Congo, Republic of the',-1,15);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Cook Islands',-21.23333358764648,-159.7666625976562);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Coral Sea Islands',-18,152);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Costa Rica',10,-84);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Cote d\47Ivoire',NULL,NULL);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Croatia',45.16666793823242,15.5);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Cuba',21.5,-80);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Cyprus',35,33);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Czech Republic',49.75,15.5);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Denmark',56,10);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Dhekelia',NULL,NULL);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Djibouti',11.5,43);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Dominica',15.41666698455811,-61.33333206176758);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Dominican Republic',19,-70.66666412353516);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('East Timor',NULL,NULL);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Ecuador',-2,-77.5);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Egypt',27,30);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('El Salvador',13.83333301544189,-88.91666412353516);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Equatorial Guinea',2,10);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Eritrea',15,39);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Estonia',59,26);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Ethiopia',8,38);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Europa Island',-22.33333396911621,40.36666488647461);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('European Union',NULL,NULL);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Falkland Islands (Islas Malvinas)',-51.75,-59);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Faroe Islands',62,-7);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Fiji',-18,175);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Finland',64,26);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('France',46,2);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('French Guiana',4,-53);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('French Polynesia',-15,-140);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('French Southern and Antarctic Lands',-43,67);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Gabon',-1,11.75);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Gambia, The',13.46666622161865,-16.5666675567627);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Gaza Strip',31.41666603088379,34.33333206176758);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Georgia',42,43.5);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Germany',51,9);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Ghana',8,-2);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Gibraltar',36.18333435058594,-5.366666793823242);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Glorioso Islands',-11.5,47.33333206176758);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Greece',39,22);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Greenland',72,-40);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Grenada',12.11666679382324,-61.66666793823242);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Guadeloupe',16.25,-61.58333206176758);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Guam',NULL,NULL);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Guatemala',15.5,-90.25);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Guernsey',49.46666717529297,-2.583333253860474);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Guinea',11,-10);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Guinea-Bissau',12,-15);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Guyana',5,-59);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Haiti',19,-72.41666412353516);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Heard Island and McDonald Islands',-53.09999847412109,72.51667022705078);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Holy See (Vatican City)',41.90000152587891,12.44999980926514);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Honduras',15,-86.5);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Hong Kong',22.25,114.1666641235352);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Howland Island',0.800000011920929,-176.6333312988281);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Hungary',47,20);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Iceland',65,-18);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('India',20,77);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Indian Ocean',-20,80);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Indonesia',-5,120);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Iran',32,53);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Iraq',33,44);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Ireland',53,-8);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Israel',31.5,34.75);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Italy',42.83333206176758,12.83333301544189);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Jamaica',18.25,-77.5);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Jan Mayen',71,-8);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Japan',36,138);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Jarvis Island',-0.3666666746139526,-160.0500030517578);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Jersey',49.25,-2.166666746139526);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Johnston Atoll',16.75,-169.5166625976562);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Jordan',31,36);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Juan de Nova Island',-17.04999923706055,42.75);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Kazakhstan',48,68);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Kenya',1,38);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Kingman Reef',6.400000095367432,-162.3999938964844);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Kiribati',1.416666626930237,173);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Korea, North',40,127);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Korea, South',37,127.5);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Kuwait',29.5,45.75);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Kyrgyzstan',41,75);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Laos',18,105);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Latvia',57,25);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Lebanon',33.83333206176758,35.83333206176758);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Lesotho',-29.5,28.5);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Liberia',6.5,-9.5);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Libya',25,17);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Liechtenstein',47.16666793823242,9.533333778381348);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Lithuania',56,24);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Luxembourg',49.75,6.166666507720947);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Macau',22.16666603088379,113.5500030517578);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Macedonia',NULL,NULL);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Madagascar',-20,47);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Malawi',-13.5,34);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Malaysia',2.5,112.5);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Maldives',3.25,73);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Mali',17,-4);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Malta',35.83333206176758,14.58333301544189);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Man, Isle of',54.25,-4.5);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Marshall Islands',9,168);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Martinique',14.66666698455811,-61);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Mauritania',20,-12);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Mauritius',-20.28333282470703,57.54999923706055);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Mayotte',-12.83333301544189,45.16666793823242);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Mexico',23,-102);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Micronesia, Federated States of',6.916666507720947,158.25);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Midway Islands',28.21666717529297,-177.3666687011719);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Moldova',47,29);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Monaco',43.73333358764648,7.400000095367432);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Mongolia',46,105);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Montserrat',16.75,-62.20000076293945);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Morocco',32,-5);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Mozambique',-18.25,35);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Namibia',-22,17);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Nauru',-0.5333333611488342,166.9166717529297);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Navassa Island',18.41666603088379,-75.03333282470703);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Nepal',28,84);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Netherlands',52.5,5.75);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Netherlands Antilles',12.25,-68.75);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('New Caledonia',-21.5,165.5);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('New Zealand',-41,174);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Nicaragua',13,-85);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Niger',16,8);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Nigeria',10,8);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Niue',-19.03333282470703,-169.8666687011719);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Norfolk Island',-29.03333282470703,167.9499969482422);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Northern Mariana Islands',15.19999980926514,145.75);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Norway',62,10);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Oman',21,57);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Other',NULL,NULL);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Pacific Ocean',0,-160);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Pakistan',30,70);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Palau',7.5,134.5);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Palmyra Atoll',5.866666793823242,-162.1000061035156);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Panama',9,-80);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Papua New Guinea',-6,147);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Paracel Islands',16.5,112);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Paraguay',-23,-58);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Peru',-10,-76);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Philippines',13,122);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Pitcairn Islands',-25.0666675567627,-130.1000061035156);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Poland',52,20);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Portugal',39.5,-8);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Puerto Rico',18.25,-66.5);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Qatar',25.5,51.25);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Reunion',-21.10000038146973,55.59999847412109);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Romania',46,25);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Russia',60,100);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Rwanda',-2,30);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Saint Helena',-15.93333339691162,-5.699999809265137);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Saint Kitts and Nevis',17.33333396911621,-62.75);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Saint Lucia',13.88333320617676,-61.13333511352539);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Saint Pierre and Miquelon',46.83333206176758,-56.33333206176758);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Saint Vincent and the Grenadines',13.25,-61.20000076293945);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Samoa',-13.58333301544189,-172.3333282470703);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('San Marino',43.76666641235352,12.41666698455811);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Sao Tome and Principe',1,7);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Saudi Arabia',25,45);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Senegal',14,-14);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Serbia and Montenegro',NULL,NULL);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Seychelles',-4.583333492279053,55.66666793823242);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Sierra Leone',8.5,-11.5);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Singapore',1.366666674613953,103.8000030517578);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Slovakia',48.66666793823242,19.5);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Slovenia',46,15);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Solomon Islands',-8,159);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Somalia',10,49);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('South Africa',-29,24);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('South Georgia and the South Sandwich Islands',-54.5,-37);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Southern Ocean',-65,0);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Spain',40,-4);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Spratly Islands',8.633333206176758,111.9166641235352);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Sri Lanka',7,81);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Sudan',15,30);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Suriname',4,-56);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Svalbard',78,20);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Swaziland',-26.5,31.5);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Sweden',62,15);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Switzerland',47,8);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Syria',35,38);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Taiwan',23.5,121);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Tajikistan',39,71);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Tanzania',-6,35);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Thailand',15,100);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Togo',8,1.166666626930237);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Tokelau',-9,-172);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Tonga',-20,-175);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Trinidad and Tobago',11,-61);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Tromelin Island',-15.86666679382324,54.41666793823242);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Tunisia',34,9);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Turkey',39,35);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Turkmenistan',40,60);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Turks and Caicos Islands',21.75,-71.58333587646484);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Tuvalu',-8,178);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Uganda',1,32);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Ukraine',49,32);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('United Arab Emirates',24,54);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('United Kingdom',54,-2);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('United States',38,-97);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Uruguay',-33,-56);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Uzbekistan',41,64);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Vanuatu',-16,167);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Venezuela',8,-66);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Vietnam',16,106);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Virgin Islands',18.33333396911621,-64.83333587646484);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Wake Island',19.28333282470703,166.6000061035156);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Wallis and Futuna',-13.30000019073486,-176.1999969482422);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('West Bank',32,35.25);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Western Sahara',24.5,-13);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Yemen',15,48);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Zambia',-15,30);
insert soft DB.DBA.WA_COUNTRY(WC_NAME,WC_LAT,WC_LNG) VALUES('Zimbabwe',-20,30);
...
create procedure WA_MEMBER_URLS (in uid int)
{
  ...
  declare pos, IS_DEFAULT int;

  result_names (_WAI_NAME, HP_HOST, HP_LPATH, HP_LISTEN_HOST, IS_DEFAULT, DEF_PAGE);
  ...
  for select WAM_HOME_PAGE, WAM_INST, WAI_ID, WAM_APP_TYPE from WA_MEMBER, WA_INSTANCE
	...
	DEF_PAGE := 'index.vspx';
      if (length (lpath) > 1)
        lpath := rtrim (lpath, '/');
      result (WAM_INST, '*ini*', lpath, '*ini*', 1, DEF_PAGE);
    }
  for select WAI_NAME, VH_HOST, VH_LPATH, VH_LISTEN_HOST, VH_PAGE from WA_VIRTUAL_HOSTS, WA_INSTANCE, WA_MEMBER
    where WAI_ID = VH_INST and WAM_INST = WAI_NAME and WAM_USER = uid and WAM_MEMBER_TYPE = 1 do
      {
	result (WAI_NAME, VH_HOST, VH_LPATH, VH_LISTEN_HOST, 0, VH_PAGE);
      }
};
