...
BMK.updateRow = function (prefix, No, optionObject)
{
  if (No != null)
  {
  ...
  else
  {
    ...
    if (tbl)
    {
      ...
      if (fldOptions)
      {
        ...
        tr.appendChild(td);
        BMK.updateCell (td, prefix, '_fld_1_', No, fldOptions)
      }
      ...
      if (fldOptions)
      {
        var td = OAT.Dom.create('td');
        tr.appendChild(td);
        BMK.updateCell (td, prefix, '_fld_2_', No, fldOptions)
      }
      ...
      if (fldOptions)
      {
        var td = OAT.Dom.create('td');
        tr.appendChild(td);
        BMK.updateCell (td, prefix, '_fld_3_', No, fldOptions)
      }
      var td = OAT.Dom.create('td');
      tr.appendChild(td);
      ...
      fld.onclick = function (){BMK.updateRow(prefix, No);};
      td.appendChild(fld);
...
BMK.updateCell = function (td, prefix, fldName, No, optionObject)
{
  fldName = prefix + fldName + No;
  if (optionObject.mode == 1)
  {
	  BMK.updateRowCombo(td, fldName, optionObject);
	}
  else if (optionObject.mode == 2)
  {
	  BMK.updateRowCombo2(td, fldName, optionObject);
  }
  else if (optionObject.mode == 3)
  {
	  BMK.updateRowCombo3(td, fldName, optionObject);
  }
  else
  {
	  BMK.updateInput(td, fldName, optionObject);
  }
}

BMK.updateInput = function (elm, fldName, fldOptions)
{
  var fld = OAT.Dom.create("input");
  fld.type = 'text';
  fld.id = fldName;
...
BMK.updateRowCombo = function (elm, fldName, fldOptions)
{
...
BMK.updateRowComboOption = function (cc, optionName)
{
  cc.addOption(optionName, optionName);
}

BMK.updateRowComboOption2 = function (elm, elmValue, optionName, optionValue)
{
...
BMK.updateRowCombo2 = function (elm, fldName, fldOptions)
{
...
BMK.updateRowCombo3 = function (elm, fldName, fldOptions)
{
	var cc = OAT.Dom.create("select");
  cc.name = fldName;
  cc.id = fldName;
	BMK.updateRowComboOption2 (cc, fldOptions.value, "Grant", "G");
	BMK.updateRowComboOption2 (cc, fldOptions.value, "Revoke", "R");
